...
const Footer = () => {
  return (
    <footer className="bg-black w-full dark:bg-gray-900">
      <div className="container px-14 md:px-28  grid place-items-center grid-cols-1  md:grid-cols-2 lg:grid-cols-3   gap-0 md:gap-28 lg:gap-[200px] mx-auto p-4 py-6 lg:py-8">
        <div className="mb-6 ">
          <a
            href="https://flowbite.com/"
            className="flex items-center gap-5 m-2"
          >
            <Image
